...
| --- | --- | --- | --- | --- |
|  | [run.py](https://github.com/colmwoods/PwdShell/blob/main/run.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/colmwoods/PwdShell/main/run.py) | ![screenshot](documentation/validation/py--run.png) | ⚠️ Notes (if applicable) |
...
Alternatively, an improved way to manage bugs is to use the built-in **[Issues](https://www.github.com/colmwoods/PwdShell/issues)** tracker on your GitHub repository. This can be found at the top of your repository, the tab called "Issues".
...
I've used [GitHub Issues](https://www.github.com/colmwoods/PwdShell/issues) to track and manage bugs and issues during the development stages of my project.

All previously closed/fixed bugs can be tracked [here](https://www.github.com/colmwoods/PwdShell/issues?q=is%3Aissue+is%3Aclosed+label%3Abug).
...
Any remaining open issues can be tracked [here](https://www.github.com/colmwoods/PwdShell/issues?q=is%3Aissue+is%3Aopen+label%3Abug).
